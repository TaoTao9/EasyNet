...
# class DiscriminativeSubNetwork(torch.nn.Module):  #(batch*28*28,1536)->(batch*28*28,1)
#     def __init__(self,in_channels=6, out_channels=2, train_model=True):
...
#             nn.Conv2d(self.in_channels,self.hidden_size1, kernel_size=1, stride=1),
#             nn.BatchNorm2d(self.hidden_size1),
#             nn.LeakyReLU(0.2),
#             nn.Conv2d(self.hidden_size1,self.hidden_size2, kernel_size=1, stride=1),
#             nn.BatchNorm2d(self.hidden_size2),
#             nn.LeakyReLU(0.2),
#             nn.Conv2d(self.hidden_size2,self.out_channels, kernel_size=1, stride=1),
