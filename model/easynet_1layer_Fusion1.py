...
class ReconstructiveSubNetwork(nn.Module):
    ...
    def forward(self, x, d):
        ...
        mask_rgb = self.mlp(torch.cat((b1,dd4), dim=1))
        mask = self.mlp1(torch.cat((b1,db4,d1,dd4), dim=1))
        return output, output_d, mask, mask_rgb, self.avg_pool(torch.cat((b1,dd4), dim=1)), self.avg_pool(torch.cat((b1,db4,d1,dd4)))
