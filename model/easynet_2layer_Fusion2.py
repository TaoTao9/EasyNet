...
class ReconstructiveSubNetwork(nn.Module):
    ...
    def forward(self, d, merge_rgb):
        ...
        mask = self.mlp4(torch.cat((merge_rgb,merge_d1,merge_d2), dim=1))
        return output_d, mask, self.avg_pool(merge_rgb), torch.cat((self.avg_pool(merge_rgb),self.avg_pool(merge_d1),self.avg_pool(merge_d2)),dim=1)
